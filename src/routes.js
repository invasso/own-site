...
const DigitalMarketing = React.lazy(() =>
  import('./pages/Pages/ServicesDetails/DigitalMarketing'),
);
const MobileApplicationDevelopment = React.lazy(() =>
  import('./pages/Pages/ServicesDetails/MobileApplicationDevelopment'),
);
const QaServices = React.lazy(() =>
  import('./pages/Pages/ServicesDetails/QaServices'),
);
const SoftwareDevelopment = React.lazy(() =>
  import('./pages/Pages/ServicesDetails/SoftwareDevelopment'),
);
const SoftWareProjectRescue = React.lazy(() =>
  import('./pages/Pages/ServicesDetails/SoftWareProjectRescue'),
);
const UiServices = React.lazy(() =>
  import('./pages/Pages/ServicesDetails/UiServices'),
);
//Shop
...
const routes = [
  ...
  },
  {
    ...
    component: MobileApplicationDevelopment,
    isTopbarDark: true,
  },
  {
    path: '/qa-services',
  ...
  },
  {
    ...
    component: SoftWareProjectRescue,
    isTopbarDark: true,
  },
  {
    path: '/ui-ux-services',
