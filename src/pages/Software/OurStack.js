...
import FeaturedJobBox from '../Job/FeaturedJobBox';
...
export class OurStack extends Component {
  state = {
    jobs: [
      {
        id: 1,
    ...
    return (
      <React.Fragment>
        <Container className="mt-100 mt-60">
          {/* section title */}
          <SectionTitle title="Our Stack" desc="" />
          ...
          <Row>
            ...
            <Col xs="12" className="text-center mt-4 pt-2">
              <Link to="/page-jobs" className="btn btn-primary">
                See All Stacks <i className="mdi mdi-chevron-right"></i>
              </Link>
            </Col>
          </Row>
        </Container>
